      ...
      <div class="row mt-5">
        <div class="col-6 m-auto p-5 rounded shadow border">
          <form>
            ...
            <div>
              <h1 class="text-center">SaCode</h1>
              <p class="text-center">#PapuanCodingSchool #PapuanTeachCommunity</p>
            </div>
            <br>
            ...
            <div  class="form-group mb-3">
              <div class="form-label text muted" for="alamat-email">Masukan alamat email anda</div>
              <input type="email" name="" id="alamat-email" class="form-control form-control-lg py-3" placeholder="Alamat email">
            </div>
            <br>

            <button class="w-100 btn btn-lg btn-primary py-3 fw-bold" type="submit">Kirim</button>
